...
def main(unused_argv):
  ...
  if hps.mode == 'decode':
    ...
    decoded = decoder.decode() # decode indefinitely (unless single_pass=True, in which case deocde the dataset exactly once)
    print(decoded)

    return decoded
  else:
    raise ValueError("The 'mode' flag must be decode")
